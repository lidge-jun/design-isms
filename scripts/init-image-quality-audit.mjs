...
const output = join(root, 'devlog/_fin/260715_production_upgrade/091_image_quality_audit.csv');
if (existsSync(output)) throw new Error('audit CSV already exists');
const receipt = JSON.parse(readFileSync(join(root, 'devlog/_fin/260715_production_upgrade/095_image_baseline_sheet_receipts.json'), 'utf8'));
