...
| MODIFY | index.html | mount recipe section after catalog-entry and before existing filters; load five core scripts plus app-language and chooser in explicit order, stylesheet after theme/nav |
