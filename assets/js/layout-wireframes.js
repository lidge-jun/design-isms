"use strict";
var LayoutWireframes;
(function (LayoutWireframes) {
    LayoutWireframes.wireframeTypes = [
    ...
    function isWireframeType(value) {
        return LayoutWireframes.wireframeTypes.includes(value);
    }
    LayoutWireframes.isWireframeType = isWireframeType;
    const structures = {
